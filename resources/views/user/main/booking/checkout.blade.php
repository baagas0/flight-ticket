                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" disabled
                                                            value="{{ $schedule->destination_code }}" class="form-control"
                                                            placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="tg-widgetcontent">
                                                    <ul>
                                                        <li class="tg-personprice">
                                                            <div class="tg-perperson"><span>Price {{ $type }}</span><em>Rp{{ number_format($price, 2) }}</em>
                                                            </div>
                                                        </li>
                                                        <li><span>Number of Person</span><em>{{ number_format($person) }}</em></li>
                                                        <li class="tg-totalprice">
                                                            <div class="tg-totalpayment"><span>Total
                                                                    Price</span><em>{{ number_format($total, 2) }}</em></div>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
