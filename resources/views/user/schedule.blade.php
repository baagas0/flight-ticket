                    ...
                    <div class="tg-tourbookingdetail">
                        <div class="tg-bookinginfo">
                            ...
                            <div class="tg-pricearea">
                                <span>From</span>
                                <h4>Rp{{ number_format($schedule->transportation->economy_chair, 2) }}<sub>/ per
                                        person</sub></h4>
                            </div>
                            ...
                            <form name="checkout" id="checkout" class="tg-formtheme tg-formbookingdetail float-right" method="GET"
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <div class="tg-formicon"><i class="icon-users"></i></div>
                                        <span class="tg-select">
                                            <select name="number_of_person" class="selectpicker" data-live-search="true" data-width="100%">
                            ...
                            <ul class="tg-tripinfo">
                                ...
                                <li><span class="tg-tourduration tg-availabilty">Economy:
                                        Rp{{ number_format($schedule->transportation->economy_chair, 2) }}</span>
                                </li>
                                <li><span class="tg-tourduration tg-location">Bussiness:
                                        Rp{{ number_format($schedule->transportation->bussiness_chair, 2) }}</span></span>
                                </li>
                                <li><span class="tg-tourduration tg-peoples">First:
                                        Rp{{ number_format($schedule->transportation->first_chair, 2) }}</span></span>
                                </li>
                            </ul>
