...
class BookingController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        switch ($type) {
            case 'Economy':
                $price = $booking->schedulle->transportation->economy_price;
                break;
            case 'Bussiness':
                $price = $booking->schedulle->transportation->bussiness_price;
                break;
            case 'First':
                $price = $booking->schedulle->transportation->first_price;
                break;
            default:
                $price = $booking->schedulle->transportation->economy_price;
                break;
    ...
    public function checkout(Request $request, $schedule)
    {
        ...
        switch ($type) {
            case 'Economy':
                $price = $schedule->transportation->economy_price;
                break;
            case 'Bussiness':
                $price = $schedule->transportation->bussiness_price;
                break;
            case 'First':
                $price = $schedule->transportation->first_price;
                break;
            default:
                $price = $schedule->transportation->economy_price;
                break;
